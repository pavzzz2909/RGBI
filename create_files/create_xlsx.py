...
def do_excel(dict_RGBI,dict_all):
    list_buy = ['Дата окончания купона',
                ...
                'Цена оферты',
                'тикер']
    list_buy2 = ['Дата окончания купона',
                 'Валюта номинала',
                 'Дата оферты',
                 'Дата последних торгов',
                 'Дата, к кот.рассч.дох.',
    ...
    xls_file(dict_all, 'files/облигации-листинг 1-эффективная доходность.xlsx', sort='Эффективная доходность', drop1=1, for_buy=list_buy2)
    xls_file(dict_all, 'files/облигации-листинг 1-период до 91 дня-эффективная доходность.xlsx', sort='Эффективная доходность', drop1=1, period=91, for_buy=list_buy2)
    xls_file(dict_all, 'files/облигации-листинг 1-период до 31 дня-эффективная доходность.xlsx', sort='Эффективная доходность', drop1=1, period=31, for_buy=list_buy2)
